            ...
            <div class="card">
                <div class="card-header">
                    <div class="row d-flex justify-content-between">
                        ...
                        <div class="col">
                            ...
                            &nbsp;
                            <h6 class="card-subtitle text-muted ml-2">
                                <span class="small">
                                    Kayıt Yapan:
                                </span>
                                {{ $user->name}}</h6>
                            ...
                            <form action="/portfolyo/{{$musteri->id}}" id="musteriSil" method="post">
                                ...
                                <button class="btn btn-danger float-right">Sil</button> @endif </form>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <h6 class="card-subtitle text-muted">Son Güncelleme:
                    ...
                    <form id=musteriGuncelle action="/portfolyo/musteriGuncelle/{{ $musteri->id }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="sehir" name="sehir"
                                    placeholder="{{ $musteri->sehir }}" value="{{ $musteri->sehir  }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3 ">
                                ...
                                <input type="text" id="tc" class="form-control" name="tc"
                                    placeholder="{{ $musteri->tc }}" value="{{ $musteri->tc  }}">
                            </div>
                            <div class="col-md-3">
                                <label for="isiminput" class="small">E-Devlet Şifresi</label>
                                <input type="text" class="form-control" id="edevlet_sifresi" name="edevlet_sifresi"
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="email_sifresi" name="email_sifresi"
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col d-flex">
                            ...
                            <a name="" id="" data-toggle="modal" data-target="#Tahsilat" class="btn btn-success"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-4">
                <form action="{{ url('dosyaKaydet') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        @if ($musteri->f1 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Girişimcilik
                                Belgesi</span>
                            <div class="div">
                        ...
                        <div class="mb-2">
                            <div class="p-2 col d-flex flex-column border">
                                <span
                                    style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Girişimcilik
                                    Belgesi</span>
                                <div class="div mt-2">
                    ...
                    <div class="row">
                        @if ($musteri->f2 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Vergi
                                Levhası</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f3 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Oda
                                Kaydı</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f4 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Faaliyet
                                Belgesi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f5 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Sicil
                                Gazetesi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f6 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Kobi
                                Beyannamesi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f8 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Proforma
                    ...
                    <div class="row">
                        @if ($musteri->f9 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">İş
                                Modeli</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f10 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Başvuru
                                Formu</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f11 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Kurul Kararı
                                Formu</span>
                            <div class="div">
                        ...
                        <div class="mb-2">
                            <div class="p-2 col d-flex flex-column border">
                                <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Kurul
                                    Kararı Formu</span>
                                <div class="div mt-2">
                    ...
                    <div class="row">
                        @if ($musteri->f12 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Kuruluş
                                Talebi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f13 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Makine
                                Talebi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f14 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Performans
                                Talebi</span>
                            <div class="div">
                    ...
                    <div class="row">
                        @if ($musteri->f15 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Diğer 1</span>
                            <div class="div">
                        ...
                        <div class="mb-2">
                            <div class="p-2 col d-flex flex-column border">
                                <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Diğer
                                    1</span>
                                <div class="div mt-2">
                    ...
                    <div class="row">
                        @if ($musteri->f16 != null)
                        <div class="p-2 col d-flex flex-column border">
                            <span style="font-size: 14pt;font-weight:bold;border-bottom:1pt solid black">Diğer 2</span>
                            <div class="div">
